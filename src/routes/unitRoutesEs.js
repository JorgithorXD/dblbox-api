...
router.get('/all', async (req, res) => {
    try {
        ...
        const dataUnitBasicEs = await getData.getAll('unit_basic_es')
        const dataUnitAbilities = await getData.getAll('unit_abilities_es')
        const dataUnitArts = await getData.getAll('unit_arts_es')
        const dataUnitZenkai = await getData.getAll('unit_zenkai_es')
        const dataUnitZenkaiArts = await getData.getAll('unit_arts_zenkai_es')
