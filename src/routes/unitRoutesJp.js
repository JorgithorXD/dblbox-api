...
router.get('/all', async (req, res) => {
    try {
        ...
        const dataUnitBasicEs = await getData.getAll('unit_basic_jp')
        const dataUnitAbilities = await getData.getAll('unit_abilities_jp')
        const dataUnitArts = await getData.getAll('unit_arts_jp')
        const dataUnitZenkai = await getData.getAll('unit_zenkai_jp')
        const dataUnitZenkaiArts = await getData.getAll('unit_arts_zenkai_jp')
